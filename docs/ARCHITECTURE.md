...
5. The API and `/tiempo-real` publish a bounded snapshot. `/metrics` exposes low-cardinality counters, gauges and histograms.
...
See [design decisions](DESIGN_DECISIONS.md), [security model](SECURITY_MODEL.md), and [operations](OPERATIONS.md).
